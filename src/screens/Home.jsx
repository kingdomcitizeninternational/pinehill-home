        ...
        <div class="navbar-area">
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            ...
                            <div class="others-options">
                                <a href="https://pinehill-frontend.onrender.com/login" target="_blank" class="login-btn">
            ...
            <div className={isShow ? `${styles.show}` : `${styles.menu_1}`}>
                <ul className={styles.listcontainer}>
                    ...
                    <li className={styles.listitemlast}><a href="https://pinehill-frontend.onrender.com/login" >LOGIN</a><a href="https://pinehill-frontend.onrender.com/signup" >SIGNUP</a></li>
                </ul>
                ...
                <div class="d-table-cell">
                    <div class="container" >
                        <div class="main-banner-content"  >
                            <h1 >Pine Hill Credit Union - work hard.Bank simple</h1>
