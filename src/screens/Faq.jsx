        ...
        <div className='navbar-area'>
                    ...
                    <nav className="navbar navbar-expand-md navbar-light">
                        ...
                        <div className="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            ...
                            <div className="others-options">
                                <a href="https://example.com/login" target="_blank" className="login-btn">
            ...
            <div className={isShow?`${styles.show}`:`${styles.menu_1}`}>
                <ul className={styles.listcontainer}>
                    ...
                    <li className={styles.listitemlast}><a href="https://example.com/login" >LOGIN</a><a href="https://example.com/signup" >SIGNUP</a></li>
                </ul>
